...
export default function AlertaCritico() {
  ...
  useGSAP(() => {
    ...
    // Single timeline: fade-in → visible → fade-out
    // Avoids two separate tweens conflicting on the same properties
    ...
    // 30%→70%: stay fully visible
    tl.to(content,
      { opacity: 1, y: 0, duration: 0.4 }
    )
    // 70%→100%: fade out + lift
    tl.to(content,
    ...
    >
      ...
      <div ref={contentRef} className="relative z-10 max-w-[680px] w-full md:ml-auto md:mr-[8%] pt-20 pb-[220px] md:pb-20" style={{ opacity: 0 }}>
        ...
        <h2 className="font-heading text-[clamp(1.5rem,5.5vw,2.4rem)] md:text-[clamp(1.8rem,3vw,2.8rem)] font-semibold leading-[1.2] tracking-[-0.02em] mb-5 md:mb-6">
          Escalar sem estrutura é o caminho mais rápido{' '}
          <span className="accent">para o colapso.</span>
        </h2>
        ...
        <p className="text-text-muted text-[clamp(0.95rem,3.5vw,1.05rem)] md:text-[clamp(1.05rem,1.2vw,1.15rem)] leading-[1.65] md:leading-[1.7] max-w-[560px]">
          Rutura de estoque, devoluções em massa e margens destruídas. Este é o preço de vender
          na internet sem uma base sólida. Antes de gastar dinheiro com anúncios, precisa de
          garantir que a sua operação aguenta o volume. Nós blindamos a sua estrutura.
        </p>
