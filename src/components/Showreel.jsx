...
export default function Showreel() {
  ...
  return (
    <section id="showreel" ref={sectionRef} className="w-full py-20 md:py-32">
      ...
      <div className="px-[5%] mb-10 md:mb-14">
        <div className="max-w-[680px]">
          ...
          <h2 className="reveal font-heading text-[clamp(1.5rem,5.5vw,2.4rem)] md:text-[clamp(1.8rem,3vw,2.8rem)] font-semibold leading-[1.2] tracking-[-0.02em] mb-4 md:mb-5">
            Sistemas que suportam a{' '}
            <span className="accent">pressão da escala.</span>
          </h2>
          <p className="reveal text-text-muted text-[clamp(0.95rem,3.5vw,1.05rem)] md:text-[clamp(1.05rem,1.2vw,1.15rem)] leading-[1.65] max-w-[560px]">
            Veja como transformamos operações engessadas em máquinas de alta performance.
            De migrações complexas a arquiteturas headless, construímos para velocidade
            e estabilidade extrema.
          </p>
        </div>
      </div>
      ...
      <div
        ref={videoRef}
        className="reveal relative w-full aspect-video bg-bg-surface overflow-hidden"
      >
        <div className="absolute inset-0 flex items-center justify-center">
          {/* Placeholder — will be replaced with YouTube embed */}
