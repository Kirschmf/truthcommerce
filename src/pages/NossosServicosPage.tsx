...
const SERVICE_ITEMS: ServiceItem[] = [
  ...
  },
  {
    ...
    text: 'Procurando uma solução de logística integrada para o seu e-commerce? Temos exatamente o que você precisa. Nossa expertise em logística integrada permite que você simplifique suas operações de entrega, gerenciando de forma eficiente todo o processo. Garanta entregas rápidas, rastreamento de pedidos em tempo real e uma experiência impecável para seus clientes.',
  },
  {
    index: '05',
    title: 'Dropshipping Profissional',
    text: 'Quer iniciar um negócio de dropshipping de sucesso? Conte com nosso serviço de dropshipping profissional. Com nossa expertise em gerenciamento de fornecedores, processos de pedido e logística, oferecemos soluções completas para você iniciar e expandir seu negócio. Esqueça as preocupações com estoque e envio e deixe a operação sob controle.',
  },
  {
    index: '06',
      ...
      <section className="relative overflow-hidden px-[5%] pt-36 pb-18 md:pt-44 md:pb-24">
        ...
        <div className="max-w-[1180px] mx-auto grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-end">
          ...
          <div className="space-y-6 text-text-muted text-[1rem] md:text-[1.08rem] leading-[1.8] max-w-[560px]">
            <p>
              A Truth é líder porque se preocupa com os resultados de seus clientes. Entenda o que podemos oferecer para você.
            </p>
            <p>Desenvolvemos soluções personalizadas e inovadoras para ajudar empresas a terem sucesso online.</p>
            <p>
            ...
            <p>Se você está pronto para levar seu e-commerce para o próximo nível, nós estamos aqui para ajudar.</p>
